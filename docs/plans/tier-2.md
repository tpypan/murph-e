...
| H8 | encoder mapping | done 2026-09-20: the board is a HID gamepad, mapped in `GAMEPAD` (`docs/encoder-bringup.md`, last section) | which of X/Y is START and TALK is still the `PANEL_ROLES` default; confirm on the cabinet |
